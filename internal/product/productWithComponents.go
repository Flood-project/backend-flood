...
type ProductWithComponents struct {
	...
	IdBucha            int32  `json:"id_bucha" db:"id_bucha"`
	TipoBucha          string `json:"tipo_bucha" db:"tipo_bucha"`
	IdAcionamento      int32  `json:"id_acionamento" db:"id_acionamento"`
	TipoAcionamento string `json:"tipo_do_acionamento" db:"tipo_do_acionamento"`
	IdBase int32 `json:"id_base" db:"id_base"`
